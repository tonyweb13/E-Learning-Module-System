        ...
        <div id="editparent">
            <div id="editControls" class=" p-2 m-2 bg-light">
                <div class="btn-group">
                    ...
                    <button value="/images/no_image.png" class="btn mt-1 hide-1" id="editor_select_img" title="Upload Image" type="button" style="background-color: #f8f9fa;width: 20px;">
                        <i class="far fa-images"></i>
                    </button>
                    <input type="file" hidden name="editor_image" id="editor_image_select">
                    &emsp;
                    <button value="/images/no_image.png" title="Upload Video / Music" class="btn mt-1 hide-1" id="editor_select_img2" type="button" style="background-color: #f8f9fa;width: 20px;">
                        <i class="fas fa-film"></i>
                    </button>
                    <input type="file" hidden name="editor_image2" id="editor_image_select2">
                    &emsp;
                    <button value="/images/no_image.png" title="Upload File" class="btn mt-1 hide-1" id="editor_select_img3" type="button" style="background-color: #f8f9fa;width: 20px;">
                        <i class="far fa-file-alt"></i>
                    </button>
                    <input type="file" hidden name="editor_image3" id="editor_image_select3">
                    &emsp;
                    <button  title="Attached Link" class="btn mt-1 hide-1" id="link-btn" type="button"  style="background-color: #f8f9fa;width: 20px;">
                        <i class="fas fa-link"></i>
                    </button>
                    &emsp;
                    <button  title="Embeed Video/Image" class="btn mt-1 hide-1"  id="embed-video-btn"   type="button"  style="background-color: #f8f9fa;width: 20px;">
            ...
            <div id="editor" class="p-2 m-2 bg-light" contenteditable style="height: 500px; overflow-y: auto">
