...
<html>
    ...
    <body class="body-bg">
                ...
                <div class="container-reviews">
                    ...
                    <div class="tab-content" style="background-color: #f6f3ee !important; padding: 30px;">
                        ...
                        <div class="row space-title">
                            <div class="col-6">
                                <form class="input-group" action="/textbooks/workbooks" autocomplete="off">
                            ...
                            <div class="col-6">
                                <a href="/textbooks/workbooks/create" class="right geo-primary mb-1 button-add" data-toggle="tooltip" title="Add Work Book">
                            ...
                            <table class="table">
                                ...
                                @foreach($results as $key=> $result)
                                    <tr>
                                        <td>{{$key + 1}}</td>
                                        <td>
                                            <img src="{{$result->cover_image ?? '/img/no_image.png'}}" onerror="this.src='/img/no_image.png'" width="130px" height="100px;" class="geo-border-primary border mt-2">
                                        </td>
                                        <td>{{$result->title ?? ''}}</td>
                                        <td>
                                            <a href="/textbooks/workbooks/{{$result->id}}" data-toggle="tooltip" title="View CM" class="action-btn btn geo-primary text-light mb-1">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            
                                            <a href="/textbooks/workbooks/edit/{{$result->id}}" data-toggle="tooltip" title="Edit CM" class="action-btn btn btn-primary text-light mb-1">
        ...
        @endsection
    @include('layouts.navbar', ['title' => 'CURICULUM MAPS'])
