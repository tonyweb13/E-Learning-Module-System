        ...
        @section('content')
            <div class="review-consult">
                <div class="container-reviews">
                    ...
                    <div class="tab-content" style="background-color: #f6f3ee !important; padding: 30px 30px; border-top:1px #CCCCCC solid;">
                        <h4>Announcements</h4>
                                ...
                                <form class="input-group" action="/forums" autocomplete="off">
                                    <div class="input-group-prepend">
                                        <button class="search-btn geo-primary" data-toggle="tooltip" title="Search">
                                         ...
                                         <input type="text" class="form-control mr-12"  name="keyword" placeholder="Search Post" value="{{$keyword}}" col=13>
                                    </div>
                                </form>
                                <br><br>
                            </div>
                            ...
                            @foreach($results as $key=> $result)
                                <div style="background-color:white;padding:20px;">
                                    @if($result->added_by == $currentuser->id)
                                        <span class="right" style="display:inline-flex">
                                            <a href="/forums/edit/{{$result->id}}" data-toggle="tooltip" title="Edit Post" class="right action-btn btn mb-1">
                                                <i class="fa fa-edit fa-2x"></i>
                                            </a>
                                            &emsp;
                                            <button type="button" class="right" data-toggle="tooltip" title="Delete Post" style="margin-top:10px;background-color:white !important;color:#eb1c14;border: none;" value="{{$result->id ?? ''}}" onclick="deletePost(this.value);">
                                    ...
                                    <div class="row">
                                        <div class="col-xx-1" width="50%">
                                            <img src="{{$result->user->image ?? ''}}" onerror="this.src='/images/default.png'"  class="profile-img-forum">
                                        </div>
                                        <div class="col-md-11">
