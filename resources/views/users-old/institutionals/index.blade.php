...
<div class="row space-title">
    <div class="col-6">
        <form class="input-group" action="/users/institute" autocomplete="off">
    ...
    <div class="col-6">
        ...
        <a href="/users/institute/create" class="right geo-primary mb-1 button-add" data-toggle="tooltip" title="Add Admin">
