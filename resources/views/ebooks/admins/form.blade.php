    ...
    <div class="col-md-12">
        ...
        <div class="row pl-3 pr-3">
            ...
            <div class="col-md-4 p-1">
                ...
                <!-- <img src="{{$data->cover_image ?? '/images/no_image.png'}}" onerror="this.src='/images/no_image.png'" width="300px" height="300px;" class="geo-border-primary border mt-2" id="image"> -->
