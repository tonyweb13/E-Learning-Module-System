                                ...
                                <tr class="geo-secondary">
                                    ...
                                    @foreach($results as $key=> $result)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/users/admins/edit/{{$result->id}}" data-toggle="tooltip" title="Edit User" class="action-btn btn btn-primary text-light mb-1">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a href="/users/admins/activity/{{$result->id}}" data-toggle="tooltip" title="Activity Logs" class="action-btn btn green-pastel text-light mb-1">
