...
<body class="body-bg">
            ...
            <div class="container-reviews">
                ...
                <div class="tab-content" style="background-color: #f6f3ee !important; padding: 30px;">
                    ...
                    <div id="admin-card" class="tab-pane fade show active">
                        ...
                        <a href="/users/teachers" class="right btn btn-info mb-1 text-light" data-toggle="tooltip" title="Browse">

                          <i class="fa fa-list"></i>&nbsp;&nbsp;Browse

                        </a>

                        <h5>Add New Techer</h5>

                        <br>

                        <form class="border geo-border-primary rounded p-3" id="add-teacher-user">
    ...
    <script type="text/javascript" src="/js/users/teachers/create.js"></script>
