...
<html>
                ...
                <div class="container-reviews">
                    ...
                    <div class="tab-content" style="background-color: #f6f3ee !important; padding: 30px;">
                        ...
                        <div class="row space-title">
                            <div class="col-6">
                                <form class="input-group" action="/users/institutes" autocomplete="off">
                            ...
                            <div class="col-6">
                                ...
                                <a href="/users/institutes/create" class="right geo-primary mb-1 button-add" data-toggle="tooltip" title="Add Admin">
                                ...
                                <tr class="geo-secondary">
                                    ...
                                    @foreach($results as $key=> $result)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/users/institutes/edit/{{$result->id}}" data-toggle="tooltip" title="Edit User" class="action-btn btn btn-primary text-light mb-1">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a href="/users/institutes/activity/{{$result->id}}" data-toggle="tooltip" title="Activity Logs" class="action-btn btn green-pastel text-light mb-1">
    ...
    <script type="text/javascript" src="/js/users/institutionals/index.js"></script>
    </body>
</html>