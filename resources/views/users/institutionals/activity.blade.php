                ...
                <div class="container-reviews">
                    ...
                    <div class="tab-content" style="background-color: #f6f3ee !important; padding: 30px;">
                        ...
                        <div class="row space-title">
                            <div class="col-6">
                                <form class="input-group" action="/users/institutes/activity/{{$id}}" autocomplete="off">
                            ...
                            <div class="col-6">
                                ...
                                <a href="/users/institutes" class="right btn btn-info mb-1 text-light" data-toggle="tooltip" title="Browse">
