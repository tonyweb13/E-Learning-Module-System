            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <!-- <img src="{{$data->image ?? '/images/no_image.png'}}" onerror="this.src='/images/no_image.png'" width="80%;" style="border-radius: 50%;" class="geo-border-primary border mt-2" id="image"> -->

                        <img src="/images/no_image.png" width="80%;" style="border-radius: 50%;" class="geo-border-primary border mt-2" id="image">
