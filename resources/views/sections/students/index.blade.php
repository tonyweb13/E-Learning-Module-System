...
<body class="body-bg">
            ...
            <div class="container-reviews">
                ...
                <div class="tab-content" style="background-color: #f6f3ee !important; padding: 30px;">
                    <div id="admin-card" class="tab-pane fade show active">
                        <h5>Students in the Class</h5>
                        <br>
                        <div class="row space-title">
                            <div class="col-6">
                                <form class="input-group" action="/sections/students/{{$section->id}}" autocomplete="off">
                            ...
                            <div class="col-6">
                                <button type="button" class="btn btn-outline-danger right" onclick="unenrollStudents();">Unenroll To Class</button>
                                <a href="/sections/students/create/{{$section->id}}" class=" geo-primary mb-1 button-add" data-toggle="tooltip" title="Add Students">
    ...
    <script type="text/javascript" src="/js/sections/students/index.js"></script>
