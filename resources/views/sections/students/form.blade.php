...
<div class="col-md-12">
    ...
    <div class="row">
        <div class="col-md-6">
            <form class="input-group" action="/sections/students/create/{{$section->id}}" autocomplete="off">
        ...
        <div class="col-md-6">
            <button type="button" class="btn btn-outline-success right" onclick="enrollStudents();">Enroll To Class</button>
        </div>
    </div>
    <br>
                ...
                <div class="col-md-12 p-1">
                    <table class="table border">
                        <tr style="background-color:#0074bc;color:white;">
                            <td width="3%"><input type="checkbox" class="worksheet-row-index" id="select-all"/></td>
                            <th width="5%">S No.</th>
                            <th>Student Name</th>
                            <th>Email</th>
                            <th>Grade</th>
