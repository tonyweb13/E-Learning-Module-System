...
<html>
    ...
    <body class="body-bg">
        ...
        @section('content')
            ...
            <div class="col-md-12">
                <a href="/sections/subjects/report/export/{{$section->id}}/{{$subject->id}}"
                class="left geo-primary mb-1 button-add" data-toggle="tooltip" title="Export Grade">
                    Export Grade<i class="fas fa-file-download"></i>
                </a>
