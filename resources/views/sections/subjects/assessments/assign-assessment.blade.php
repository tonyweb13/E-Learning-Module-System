            ...
            <div class="container-reviews">
                ...
                <div class="tab-content" style="background-color: #f6f3ee !important; padding: 30px;">
                    <div id="admin-card" class="tab-pane fade show active">
                        <a href="/sections/subjects/assessment/assigned/assessement/{{$section->id}}/{{$subject->id}}/{{$assessmentid ?? ''}}" class="right btn btn-info mb-1 text-light" data-toggle="tooltip" title="Browse Assessment">
                        ...
                        <div class="border geo-border-primary rounded p-3">
                            <br> 
                            <h5 class ="headline">Browse Class Student</h5>
                            <br>
                            ...
                            <div class="row space-title">
                                <div class="col-9">
                                    <form class="input-group" action="/sections/subjects/assessment/assign/assessement/{{$section->id ?? ''}}/{{$subject->id  ?? ''}}/{{$assessmentid}}" autocomplete="off">
                                ...
                                <div class="col-3">
                                    <button type="button" class="btn btn-outline-success right" onclick="assignAssessmentStudent();">Assign Assessment</button>
                                </div>
                            </div>
                            <br>
                            <div style="overflow: auto;" class="border">
                                <table class="table">
                                    <tr class="geo-secondary">
                                        <td width="5%"><input type="checkbox" class="worksheet-row-index" id="select-all"/></td>
                                        <th with="10%">S No.</th>
                                        <th>Name</th>
                                        <th>Email</th>
                                        <th>Grade</th>
