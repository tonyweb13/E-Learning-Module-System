                ...
                <div class="tab-content" style="background-color: #f6f3ee !important; padding: 30px;">
                    <div id="admin-card" class="tab-pane fade show active">
                        ...
                        <div class="border geo-border-primary rounded p-3"> 
                            <br>
                            <h5 class ="headline">Browse Student Assigned to this Assessment</h5>
                            <br>
                            ...
                            <div class="row space-title">
                                <div class="col-9">
                                    <form class="input-group" action="/sections/subjects/assessment/assigned/assessement/{{$section->id ?? ''}}/{{$subject->id  ?? ''}}/{{$assessmentid}}" autocomplete="off">
                                ...
                                <div class="col-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <button type="button" class="btn btn-outline-danger right" onclick="unassignAssessmentStudent();">Unassign Assessment</button>
                                        </div>
                                        <div class="col-md-6">
                                            <a href="/sections/subjects/assessment/assign/assessement/{{$section->id ?? ''}}/{{$subject->id ?? ''}}/{{$assessmentid}}" class="right geo-primary mb-1 button-add" data-toggle="tooltip" title="Add Student">
