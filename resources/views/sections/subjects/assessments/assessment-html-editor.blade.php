<div class="container p-2 rounded editor-a" style="background-color: #eeeeee;">
    <div id="editparent2">
        <div id="editControls2" class=" p-2 m-2 bg-light">
            <div class="btn-group">
                ...
                <!-- hete -->
                <a class="btn text-dark" data-role="paste" href="#" onclick="editorPaste2();" title="Pate">
            ...
            <div class="btn-group">
                ...
                <select onchange="fontEditor2('fontName',this[this.selectedIndex].value)">
                ...
                &emsp;
                <select onchange="fontEditor2('fontsize',this[this.selectedIndex].value)">
                    <?php $a= 8 ?>
                    @for($i=1; $i < 8 ;$i++)
                ...
                &emsp;
                <button value="/images/no_image.png" class="btn mt-1" id="editor_select_imga2" title="Upload Image" type="button" style="background-color: #f8f9fa;width: 20px;">
                    <i class="far fa-images"></i>
                </button>
                <input type="file" hidden name="editor_imagea2" id="editor_image_selecta2">
                &emsp;
                <button value="/images/no_image.png" title="Upload Video / Music" class="btn mt-1" id="editor_select_img2a2" type="button" style="background-color: #f8f9fa;width: 20px;">
                    <i class="fas fa-film"></i>
                </button>
                <input type="file" hidden name="editor_image2a2" id="editor_image_select2a2">

                <button  title="Attached Link" class="btn mt-1" onclick="attachedLink2();"  style="background-color: #f8f9fa;width: 20px;">
                    <i class="fas fa-link"></i>
                </button>
            </div>
        </div>
        <div id="editor2" class="p-2 m-2 bg-light" contenteditable style="width:100%;height: 260px; overflow-y: auto">
            
        </div>
    </div>
</div>
@include('sections.subjects.assessments.assessment-link-modal')