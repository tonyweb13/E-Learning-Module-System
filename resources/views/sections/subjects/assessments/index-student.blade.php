                            ...
                            <table class="table text-center">
                                ...
                                @foreach($results as $key=> $result)
                                    <tr>
                                        ...
                                        <td>{{$result->mode ?? ''}}</td>
                                        <td>
                                            {{date("F j,Y", strtotime($result->start_date))}} at {{date("h:i a", strtotime($result->start_time))}}
                                        </td>
                                        <td>
                                            {{date("F j,Y", strtotime($result->end_date))}} at {{date("h:i a", strtotime($result->end_time))}}
                                        </td>
