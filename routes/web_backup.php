...
Route::get('/resend-token', 'MainHomeController@sendToken2');
...
Route::post('/users/suspend', 'AdminUsersController@suspend');
Route::post('/users/unsuspend', 'AdminUsersController@unsuspend');
